...
function allium_credits_designer() {
	$designer_string = sprintf(
		/* translators: %1$s is Theme / Designer Name ( Allium ), %2$s is WordPress */
		esc_html__( '%1$s &sdot; Powered by %2$s', 'allium' ),
		wp_kses_post( 'Allium Theme by <a href="https://templatelens.com">TemplateLens</a>' ),
		wp_kses_post( '<a href="https://wordpress.org">WordPress</a>' )
	);
